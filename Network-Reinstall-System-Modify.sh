...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -dd 'https://github.com/fei5seven/lotServer/releases/download/0.0.1/CentOS_7.X_NetInstallation.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -c 6.10 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -d 9 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -d 8 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -d 7 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -u 18.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -u 16.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -u 14.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -dd 'https://odc.mirrors.getcdn.net/Operating-System_VvuH8KEgcrS0HtzN/CXT-System/CXT_Bare-metal_System_Deployment_Platform.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/fei5seven/Network-Reinstall-System-Modify/master/CoreShell/Core_Install.sh' && bash Core_Install.sh -dd $2
fi
